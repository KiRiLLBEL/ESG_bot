...
menu_keyboard = {
    'b2b': InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(text=LEXICON_RU['b2b']['menu_button1'], callback_data="1")
            ],
            [
                InlineKeyboardButton(text=LEXICON_RU['b2b']['menu_button2'], callback_data="2")
            ],
            [
                InlineKeyboardButton(text=LEXICON_RU['b2b']['menu_button3'], callback_data="3")
            ],
            [
                InlineKeyboardButton(text=LEXICON_RU['b2b']['menu_button4'], callback_data="4")
            ]
        ]
    ),
...
callback_map = {
    ...
    "earn_score": InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(text=LEXICON_RU['earn_score']['button1'], callback_data="1")
            ],
            [
    ...
    "buy_score": InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(text=LEXICON_RU['buy_score']['button1'], callback_data="1")
            ],
            [
                InlineKeyboardButton(text=LEXICON_RU['buy_score']['button2'], callback_data="2")
            ],
            [
                InlineKeyboardButton(text=LEXICON_RU['buy_score']['button3'], callback_data="3")
            ],
            [
                InlineKeyboardButton(text=LEXICON_RU['buy_score']['button4'], callback_data="4")
            ],
            [
                InlineKeyboardButton(text=LEXICON_RU['buy_score']['button5'], callback_data="5")
            ],
            [
                InlineKeyboardButton(text=LEXICON_RU['back_button'], callback_data=MenuCallbackFactory(
                    current_keyboard='buy_score',
    ...
    'template_idea': InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(text=LEXICON_RU['template_idea']['button1'], callback_data="1")
            ],
            [
                InlineKeyboardButton(text=LEXICON_RU['template_idea']['button2'], callback_data="2")
            ],
            [
                InlineKeyboardButton(text=LEXICON_RU['template_idea']['button3'], callback_data="3")
            ],
            [
                InlineKeyboardButton(text=LEXICON_RU['back_button'], callback_data=MenuCallbackFactory(
    ...
    "plan_idea": InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(text=LEXICON_RU['plan_idea']['button1'], callback_data="1")
            ],
            [
                InlineKeyboardButton(text=LEXICON_RU['plan_idea']['button2'], callback_data="2")
            ],
            [
                InlineKeyboardButton(text=LEXICON_RU['plan_idea']['button3'], callback_data="3")
            ],
            [
                InlineKeyboardButton(text=LEXICON_RU['back_button'], callback_data=MenuCallbackFactory(
    ...
    "what_study": InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(text=LEXICON_RU['what_study']['button1'], callback_data="1")
            ],
            [
                InlineKeyboardButton(text=LEXICON_RU['what_study']['button2'], callback_data="2")
            ],
            [
                InlineKeyboardButton(text=LEXICON_RU['what_study']['button3'], callback_data="3")
            ],
            [
                InlineKeyboardButton(text=LEXICON_RU['back_button'], callback_data=MenuCallbackFactory(
    ...
    "eco_org": InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(text=LEXICON_RU['eco_org']['button1'], callback_data="1")
            ],
            [
                InlineKeyboardButton(text=LEXICON_RU['eco_org']['button2'], callback_data="2")
            ],
            [
                InlineKeyboardButton(text=LEXICON_RU['back_button'], callback_data=MenuCallbackFactory(
    ...
    'task': InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(text=LEXICON_RU['back_button'], callback_data=MenuCallbackFactory(current_keyboard='task', next_keyboard="pick_tasks").pack())
            ]
        ]
    ),
